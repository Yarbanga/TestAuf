                ...
                <li class="dropdown nav-item" data-menu="dropdown"><a
                    ...
                    <ul class="dropdown-menu" data-bs-popper="none">
                        ...
                        <li class="active" data-menu=""><a class="dropdown-item d-flex align-items-center"
                                href="user" data-bs-toggle="" data-i18n="eCommerce"><i
                                    data-feather="user"></i><span data-i18n="eCommerce">Utilisateurs</span></a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown nav-item" data-menu="dropdown"><a class=" nav-link d-flex align-items-center"><span
                            data-i18n="User Interface"></span></a>
                </li>
            </ul>
        </div>
    </div>
