        ...
        <div class="content-body">
            ...
            <div class="alert alert-danger mt-1 alert-dismissible" role="alert">
                <div class="alert-body d-flex align-items-center">
                    ...
                    <span>
                        Une erreur s'est produite lors de l'ajout d'un utilisateur à la structure 
                    </span>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <button class="dt-button create-new btn btn-primary" tabindex="0"
                                ...
                                </svg>Ajouter un utilisateur</span>
                            </button>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            @if (stristr($user->profile, 'avatar.png'))
                                            <img src="{{ asset('image/avatar.png') }}" class="me-75"
                                                height="40" width="40" alt="{{ $user->firstname }}">
                                            @else
                                            <img src="{{ asset('image/' . $user->profile) }}"
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <button type="button" class="dropdown-item delete__dish__btn" data-bs-toggle="modal" data-bs-target="#deleteModal_{{ $user->id }}">
                                            ...
                                            <div class="modal fade modal-danger text-start" id="deleteModal_{{ $user->id }}" tabindex="-1" aria-labelledby="myModalLabel120" aria-hidden="true">
                    ...
                    <div class="modal-dialog sidebar-sm">
                        <form action="" method="post" enctype="multipart/form-data"
                            ...
                            <div class="modal-header mb-1">
                                <h5 class="modal-title" id="exampleModalLabel">Formulaire d'ajout d'utilisateur</h5>
                            </div>
                            <div class="modal-body flex-grow-1">
                                <input type="hidden" name="organizationId" value=""
                                    required>
                                <div class="mb-1">
                                    <label class="form-label" for="firstname">Nom de l'utilisateur</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" id="firstname" class="form-control" name="firstname"
                                            placeholder="Entrez le nom de l'utilisateur" @if(old('firstname'))
                                ...
                                <div class="mb-1">
                                    <label class="form-label" for="lastname">Prénom de l'utilisateur</label>
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" id="lastname" class="form-control" name="lastname"
                                            placeholder="Entrez le prénom de l'utilisateur" @if(old('lastname'))
                                ...
                                <div class="mb-1">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="email" id="email" class="form-control" name="email"
                                            placeholder="Entrez l'adresse email de l'utilisateur" @if(old('email'))
                                ...
                                <div class="mb-1">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" id="localization" class="form-control"
                                                name="localization"
                                                placeholder="Entrez la localisation de l'utilisateur" />
                                        </div>
                                        @error('localization')
                                        <div class="text-danger">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
